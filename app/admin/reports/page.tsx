    ...
    <div>
      ...
      <div className="space-y-4">
        {filteredReports.map((report) => (
          <div key={report.id} className="bg-white rounded-lg shadow-sm border p-6 focus:ring-4 focus:ring-pink-400 focus:border-pink-600 focus:outline-none">
              ...
              {report.status === 'Pendente' && (
                <>
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 focus:ring-4 focus:ring-pink-400 focus:border-pink-600 focus:outline-none"
                  >
                    Marcar como Em Revisão
                  </button>
                  <button
                    onClick={() => handleUpdateStatus(report.id, 'Resolvida')}
                    className="px-3 py-1 text-xs bg-green-100 text-green-700 rounded-md hover:bg-green-200 focus:ring-4 focus:ring-pink-400 focus:border-pink-600 focus:outline-none"
                  >
              ...
              {report.status === 'Em Revisão' && (
                <>
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-red-100 text-red-700 rounded-md hover:bg-red-200 focus:ring-4 focus:ring-pink-400 focus:border-pink-600 focus:outline-none"
                  >
                    Bloquear Denunciado
                  </button>
                  <button
